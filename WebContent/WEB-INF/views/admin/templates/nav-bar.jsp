...
<nav class="navbar navbar-custom navbar-fixed-top" role="navigation">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="#"><span>Online Music</span>&nbsp;&nbsp;Admin</a>
						...
						<li>
							<div class="dropdown-messages-box">
								...
								<div class="message-body">
									<small class="pull-right">3 mins ago</small> <a href="#"><strong>luogld
									</strong> commented on <strong>your photo</strong>.</a> <br /> <small
							...
							<div class="dropdown-messages-box">
								...
								<div class="message-body">
									<small class="pull-right">1 hour ago</small> <a href="#">New
										message from <strong>luogld</strong>.
